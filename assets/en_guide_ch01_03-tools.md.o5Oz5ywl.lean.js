import{_ as e,I as t,c as l,o as r,aj as i,J as n}from"./chunks/framework.DDu2oKpN.js";const u=JSON.parse('{"title":"1.3 Common Open Source Tools","description":"Understanding the open source tool ecosystem for medical imaging processing and mastering best practices for tool selection and usage","frontmatter":{"title":"1.3 Common Open Source Tools","description":"Understanding the open source tool ecosystem for medical imaging processing and mastering best practices for tool selection and usage"},"headers":[],"relativePath":"en/guide/ch01/03-tools.md","filePath":"en/guide/ch01/03-tools.md"}'),p={name:"en/guide/ch01/03-tools.md"};function o(h,s,d,k,g,c){const a=t("Mermaid");return r(),l("div",null,[s[0]||(s[0]=i("",10)),n(a,{id:"mermaid-rmgkfp33s",code:`graph LR
    ...
    style D fill:#e1ffe1
    style E fill:#f5e1ff
    style F fill:#ffe1e1`}),s[1]||(s[1]=i("",66)),n(a,{id:"mermaid-usembty7l",code:`graph TD
    ...
    style D fill:#e1f5ff
    style G fill:#ffe1f5
    style E fill:#e1ffe1`}),s[2]||(s[2]=i("",74)),n(a,{id:"mermaid-tgtrtb6h0",code:`graph LR
    ...
    style D fill:#e1ffe1
    style E fill:#f5e1ff
    style F fill:#ffe1e1`}),s[3]||(s[3]=i("",35)),n(a,{id:"mermaid-u1nxxzxxi",code:`graph TD
